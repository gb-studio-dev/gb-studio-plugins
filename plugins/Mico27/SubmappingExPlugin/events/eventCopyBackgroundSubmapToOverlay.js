...
export const compile = (input, helpers) => {
  ...
  if (!__submapFeatureEnabled("SUBMAP_ENABLE_COPY_SCENE_TO_OVERLAY")) {
    throw new Error("This event requires the \"Copy scene submap to overlay\" engine setting to be enabled (Settings → Engine → Submapping Ex).");
  }
