export const id = "EVENT_SCROLL_OVERLAY_RECT";
export const name = "Scroll overlay rectangle by 1 tile";
export const groups = ["EVENT_GROUP_SCREEN"];

export const autoLabel = (fetchArg) => {
  return `Scroll overlay rectangle by 1 tile`;
};
...
export const compile = (input, helpers) => {
  ...
  _addComment("Scroll overlay rectangle by 1 tile");
  ...
  _callNative("vm_scroll_overlay_rect");
  _stackPop(6);
};
