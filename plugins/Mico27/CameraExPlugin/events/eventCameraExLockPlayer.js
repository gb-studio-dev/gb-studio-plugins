...
const id = "EVENT_CAMERA_EX_LOCK_PLAYER";
const name = "Camera Lock On Player";
const groups = ["EVENT_GROUP_CAMERA"];

const fields = [
  {
    label:
      "Clears the camera's follow list and returns it to the player. This is the state the camera is reset to on every scene load.",
  },
...
const compile = (input, helpers) => {
  ...
  _addComment("Camera Lock On Player");
  compileTargets([], MEDIAN_BOUNDS, helpers);
...
module.exports = {
  ...
  name,
  description:
    "Returns the camera to following the player, clearing any actors added with the other Camera Ex lock events.",
  groups,
  fields,
  compile,
