export const id = "EVENT_DYNAMIC_ACTOR_SET_PROPERTY";
export const name = "Actor Set Property (Extended)";
...
export const autoLabel = (fetchArg) => {
  return `Set ${fetchArg("property")} of actor ${fetchArg("actorId")} to ${fetchArg("value")}`;
};
