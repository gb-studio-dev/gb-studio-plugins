#!/usr/bin/env node
// ---------------------------------------------------------------------------
// Tall Text: font generator
//
// A 16px-tall font asset for the TallTextPlugin: 96 ASCII characters in
// 8x16 cells, 128x96 pixels. The plugin reads each character as a pair of
// stacked tiles, so every glyph gets the full 16px height.
//
...
const HELP = `
Usage: node make_tall_font.js [options]
...
Output:
  ...
  --name <prefix>         asset base name (default: tall)
...
const parseArgs = (argv) => {
  const opts = { name: "tall", size: 16, offsetY: 0, wizard: false, loose: [] };
