const id = "EVENT_TTX_MENU";
const name = "Tall Text: Menu";
  ...
  [
    {
      type: "label",
      label:
        "A menu drawn in tall text. The stock Menu event lays its window out for 8px " +
...
const compile = (input, helpers) => {
  ...
  // Replace stock text rendering setting is on. Calling ttx_ui_run_menu
